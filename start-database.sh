...
DB_CONTAINER_NAME="test-t3-app-mysql"
...
docker run --name $DB_CONTAINER_NAME -e MYSQL_ROOT_PASSWORD=$DB_PASSWORD -e MYSQL_DATABASE=test-t3-app -d -p 3306:3306 docker.io/mysql
